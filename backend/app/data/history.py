...
REPORT_TEMPLATES: dict[str, SessionReport] = {
    "host": SessionReport(
        ...
        radarMetrics=[
            RadarMetric(subject="控场", score=88, fullMark=100),
            RadarMetric(subject="表达", score=82, fullMark=100),
            RadarMetric(subject="互动", score=86, fullMark=100),
            RadarMetric(subject="节奏", score=80, fullMark=100),
            RadarMetric(subject="感染力", score=84, fullMark=100),
        ],
        comparisonSummary="和上次主持场景相比，你的互动感和镜头亲和力更强，整体完成度更高；如果再把节奏停顿拉开一点，控场质感会更成熟。",
    ),
    "guest-sharing": SessionReport(
        ...
        radarMetrics=[
            RadarMetric(subject="逻辑", score=90, fullMark=100),
            RadarMetric(subject="表达", score=85, fullMark=100),
            RadarMetric(subject="故事感", score=82, fullMark=100),
            RadarMetric(subject="节奏", score=83, fullMark=100),
            RadarMetric(subject="感染力", score=84, fullMark=100),
        ],
        comparisonSummary="和上一轮分享相比，你的逻辑组织和结论表达明显更稳，听感更像成熟分享者；下一步重点是把结尾的情绪推得更高一点。",
    ),
    "standup": SessionReport(
        ...
        radarMetrics=[
            RadarMetric(subject="表现力", score=84, fullMark=100),
            RadarMetric(subject="节奏", score=78, fullMark=100),
            RadarMetric(subject="停顿", score=72, fullMark=100),
            RadarMetric(subject="叙事", score=80, fullMark=100),
            RadarMetric(subject="感染力", score=81, fullMark=100),
        ],
        comparisonSummary="比上一次脱口秀试讲更自然，也更敢演了；如果把笑点后的停顿控制得更稳，现场反馈还会更好。",
    ),
}
